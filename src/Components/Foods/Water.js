    ...
    return (
        <div className="sunny-side-up-page">
            ...
            <div className="description">
                ...
                <p>Served cold with ice on hot days, or at room temperature, water pairs well with any meal or can be flavored with natural ingredients like lemon, cucumber, or mint for a hint of taste.</p>       
            </div>
