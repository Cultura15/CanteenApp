        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/porkmenudo.png" alt="Pork Menudo" />
                </div>
            ...
            <div className="description">
                ...
                <p> Pork Menudo (from Spanish: "small [bits]"), also known as ginamay or ginagmay (Cebuano: "[chopped into] smaller pieces"), 
                    is a traditional stew from the Philippines made with pork and sliced liver in tomato sauce with carrots and potatoes. </p>       
            </div>
