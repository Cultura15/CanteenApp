...
import BananaCue from './BananaCue';
    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Banana Smoothie"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/bananasmoothie.png" alt="Banana Smoothie" />
                </div>
            ...
            <div className="description">
                ...
                <p> Sweet and mellow, with the distinct taste of ripe bananas, the smoothie is often enhanced by a hint of vanilla or cinnamon. 
                    Some variations include yogurt or milk for added creaminess, 
                    while others might blend in a touch of honey or a pinch of nutmeg for extra depth. </p>       
            </div>
