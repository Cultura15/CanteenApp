    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Pork Giniling"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/porkginiling.png" alt="Pork Giniling" />
                </div>
            ...
            <div className="description">
                ...
                <p> Pork Giniling is a traditional dish in many Latin American countries including Mexico and 
                    Cuba, as well as the Philippines. It is made with ground meat (most commonly beef), tomatoes (tomato sauce may be used as a substitute), and also raisins, olives, and
                     other ingredients that vary by region. The name comes from the Spanish word picar, meaning "to mince" </p>       
            </div>
