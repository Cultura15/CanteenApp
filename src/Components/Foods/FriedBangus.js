    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Fried Bangus"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/friedbangus.png" alt="Fried Bangus" />
                </div>
            ...
            <div className="description">
                ...
                <p>Fried bangus is prepared by marinating the whole milkfish or fillets in a mixture of vinegar, garlic, and spices, which enhances its flavor. 
                    The fish is then coated lightly in flour or cornstarch before being deep-fried or pan-fried until it reaches a golden-brown crispness on the outside 
                    while remaining tender and juicy on the inside. </p>       
            </div>
