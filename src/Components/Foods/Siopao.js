    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Siopao"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/siopao.png" alt="Siopao" />
                </div>
            ...
            <div className="description">
                ...
                <p>Siopao, is a Philippine steamed bun with various fillings. 
                    ...
                    It is a popular snack in the Philippines and is commonly sold by bakeries and restaurants.</p>       
            </div>
