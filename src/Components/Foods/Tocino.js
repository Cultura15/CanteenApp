    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Pork Tocino"); // Replace with your actual condition
            ...
            <>
                <header className="header">
                    ...
                    <nav className="nav-links">
                        <a href="#menu">Menu</a>
                        <Link to="/canteen2/cart2">Cart2</Link> {/* Link to Cart */}
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/tocino.png" alt="Tocino" />
                </div>
            ...
            <div className="description">
                ...
                <p>Tocino is bacon in Spanish, typically made from the pork belly and often formed into cubes in Spain. 
                    In Caribbean countries, such as Puerto Rico and Cuba, tocino is made from pork fatback and is neither cured nor smoked but simply fried until very crunchy; it is then added to recipes, much like the way lardons are used in French cuisine. 
                    In the Philippines, tocino refers to sweetened and cured pork belly.</p>       
            </div>
