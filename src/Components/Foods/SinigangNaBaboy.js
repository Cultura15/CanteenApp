    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Sinigang Na Baboy"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/sinigangnababoy.png" alt="Sinigang Na Baboy" />
                </div>
            ...
            <div className="description">
                ...
                <p> Sinigang Na Baboy is a Filipino cuisine and food known for its sour and savory taste . 
                    It is often associated with tamarind , but may use other sour fruits and leaves, such as camyas , or guava as a leavening agent. 
                    This is one of the most popular dishes in Filipino cuisine .  </p>       
            </div>
...
export default SinigangNaBaboy;
