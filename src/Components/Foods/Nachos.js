    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Nachos"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/nachos.png" alt="Nachos" />
                </div>
            ...
            <div className="description">
                ...
                <p> Nachos are a Tex-Mex culinary dish[2][3][4][5] consisting of tortilla chips or totopos covered with cheese or cheese sauce, 
                    as well as a variety of other toppings and garnishes, often including meats such as ground beef or grilled chicken, vegetables such as chili peppers, lettuce, tomatoes, and olives, 
                    and condiments such as salsa, guacamole, or sour cream. </p>       
            </div>
