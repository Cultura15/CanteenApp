    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Meatroll Bread"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/meatrollbread.png" alt="MeatrollBread" />
                </div>
                <div className="details-container">
                    <h2>Meatroll Bread</h2>
                    <h3>95 Calories</h3>
                    <h3>&#8369; 25</h3>
                </div>
            </div>
            ...
            <div className="description">
                ...
                <p> A Meatroll Bread is a soft, freshly baked roll filled with seasoned meat, typically ground pork, beef, or chicken, 
                    sometimes mixed with onions, herbs, and a bit of sauce for extra flavor.
                     The bread is fluffy and golden brown, with a slight crust on the outside and a warm, savory filling inside. 
                     This easy-to-hold snack makes for a hearty, flavorful bite that’s both filling and convenient—perfect for a quick breakfast or a mid-morning treat at school!</p>       
            </div>
