    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Chicken Afritada"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/chickenafritada.png" alt="Chicken Afritada" />
                </div>
            ...
            <div className="description">
                ...
                <p> Afritada is a Philippine dish consisting of chicken, beef, or pork braised in tomato sauce with carrots, potatoes, and 
                    red and green bell peppers. It is served on white rice and is a common Filipino meal.
                    It can also be cooked with seafood.</p>       
            </div>
...
export default ChickenAfritada;
