    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Chocolate Smoothie"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/chocolatesmoothie.png" alt="ChocolateSmoothie" />
                </div>
            ...
            <div className="description">
                ...
                <p> Decadent and rich, with the satisfying taste of chocolate, this smoothie combines sweetness with a hint of natural bitterness from cocoa or dark chocolate.
                     It’s often slightly sweetened with honey, dates, or a banana for balance. </p>       
            </div>
...
export default ChocolateSmoothie;
