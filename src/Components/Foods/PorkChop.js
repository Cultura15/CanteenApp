    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Pork Chop"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/porkchop.png" alt="Pork Chop" />
                </div>
            ...
            <div className="description">
                ...
                <p> A Pork Chop is a classic comfort food, the fried pork chop is hearty and satisfying, perfect for a family meal or a casual dinner. 
                    Its crispy coating and tender meat make it a favorite among pork lovers. </p>       
            </div>
