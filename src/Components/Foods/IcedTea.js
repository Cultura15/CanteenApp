    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Iced Tea"); // Replace with your actual condition
    ...
    return (
        <div className="sunny-side-up-page">
            ...
            <div className="description">
                ...
                <p>Iced tea is a form of cold tea. Though it is usually served in a glass with ice, 
                    it can refer to any tea that has been chilled or cooled. 
                    It may be sweetened with sugar or syrup, or remain unsweetened.</p>       
            </div>
