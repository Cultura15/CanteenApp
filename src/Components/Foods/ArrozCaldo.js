    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Arroz Caldo"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/arrozcaldo.png" alt="Arroz Caldo" />
                </div>
            ...
            <div className="description">
                ...
                <p>Arroz caldo is a Spanish term meaning "broth rice". It is derived from the Spanish dish arroz caldoso. 
                    ...
                    It is usually served with calamansi or fish sauce (patis) as condiments, as well as a hard-boiled egg.</p>       
            </div>
