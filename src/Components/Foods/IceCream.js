    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Ice Cream"); // Replace with your actual condition
    ...
    return (
        <div className="sunny-side-up-page">
            ...
            <div className="description">
                ...
                <p>Ice cream is a frozen dessert typically made from milk or cream that has been flavoured 
                    with a sweetener, either sugar or an alternative, and a spice, such as cocoa or 
                    vanilla, or with fruit, such as strawberries or peaches.</p>       
            </div>
