        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/mami.png" alt="Mami" />
                </div>
            ...
            <div className="description">
                ...
                <p>Mami (pronounced: MAH-mee) is a popular Filipino noodle soup made with wheat flour noodles, broth and 
                    the addition of meat (chicken, beef, pork) or wonton dumplings. It is related to the pancit class of noodle dishes, and 
                    the noodles themselves are sometimes called pancit mami.</p>       
            </div>
