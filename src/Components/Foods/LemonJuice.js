    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Lemon Juice"); // Replace with your actual condition
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/lemonjuice.png" alt="Lemon Juice" />
                </div>
            ...
            <div className="description">
                ...
                <p>Lemon juice is often enjoyed diluted with water as a refreshing drink, sometimes sweetened for lemonade or mixed with herbs like mint. 
                    It’s also commonly used as a flavor enhancer for various foods, lending a fresh, bright taste to beverages, marinades, and dressings.</p>       
            </div>
