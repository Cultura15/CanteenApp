    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Scrambled Egg"); // Replace with your actual condition
            ...
            <>
                <header className="header">
                    ...
                    <nav className="nav-links">
                        <a href="#menu">Menu</a>
                        <Link to="/canteen2/cart">Cart</Link> {/* Link to Cart */}
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/scrambledegg.png" alt="Scrambled Egg" />
                </div>
            ...
            <div className="description">
                ...
                <p>Scrambled eggs is a dish made from eggs (usually chicken eggs) stirred, whipped, or 
                    beaten together typically with salt, butter, oil, and sometimes other ingredients, and heated so that they form into curds.</p>       
            </div>
