    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "CassavaCake"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Cassava Cake item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Cassava Cake not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/cassavacake.png" alt="Cassava Cake" />
                </div>
            ...
            <div className="description">
                ...
                <p>Cassava cake is a traditional Filipino moist cake made from grated cassava, coconut milk, and condensed milk with a custard layer on top. 
                    It is a very popular dish in the Philippines, where it is commonly eaten for merienda. 
                    It is also served during gatherings and special occasions.</p>       
            </div>
