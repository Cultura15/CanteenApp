    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "TortangTalong"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Tortang Talong item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Tortang Talong not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/tortangtalong.png" alt="Tortang Talong" />
                </div>
            ...
            <div className="description">
                ...
                <p>Tortang talong, also known as eggplant omelette, is an omelette or fritter from 
                    Filipino cuisine made by pan-frying grilled whole eggplants dipped in an egg mixture. 
                    It is a popular breakfast and lunch meal in the Philippines.</p>       
            </div>
