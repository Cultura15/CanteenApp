    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "BananaCue"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Banana Cue item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Banana Cue not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/bananacue.png" alt="Banana Cue" />
                </div>
            ...
            <div className="description">
                ...
                <p> Banana cue is made with deep fried banana coated in caramelized brown sugar. 
                    The bananas used for this recipe are Saba bananas, which are very commonly used for cooking in the Philippines. 
                    It is usually skewered on a bamboo stick, and sold on the streets. 
                    The skewer stick is just for ease of serving and eating, but the dish is not cooked on the skewer. </p>       
            </div>
