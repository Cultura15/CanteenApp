    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Popcorn"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Popcorn item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Popcorn not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
    ...
    return (
        <div className="sunny-side-up-page">
            ...
            <div className="description">
                ...
                <p> Popcorn is a variety of corn kernel which expands and puffs up when heated. 
                     ...
                     It is commonly eaten salted, sweetened, or with artificial flavorings.</p>       
            </div>
