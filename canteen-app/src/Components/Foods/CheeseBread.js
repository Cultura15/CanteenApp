    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "CheeseBread"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Cheese Bread item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Cheese Bread not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/cheesebread.png" alt="Cheese Bread" />
                </div>
            ...
            <div className="description">
                ...
                <p> Cheese buns or cheese breads may refer to a variety of small, baked, cheese-flavored rolls, a popular snack and breakfast food in Brazil. 
                    Cheese buns may be made with cassava and or corn starch, and cheese. In countries where the snack is popular, 
                    it is inexpensive and often sold from street vendors, bakeries, in snack shops, and in grocery stores. </p>       
            </div>
