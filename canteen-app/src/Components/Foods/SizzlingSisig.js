    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Sizzling Sisig"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Sizzling Sisig item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Sizzling Sisig not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/sisig.png" alt="SizzlingSisig" />
                </div>
                <div className="details-container">
                    <h2>Sizzling Sisig</h2>
                    <h3>215 Calories</h3>
                    <h3>&#8369; 100</h3>
                </div>
            </div>
            ...
            <div className="description">
                ...
                <p> Sizzling Sisig is a Filipino dish made from pork jowl and ears (maskara), pork belly, and chicken liver, which is usually seasoned with calamansi, onions, and chili peppers. It originates from the Pampanga region in Luzon.
