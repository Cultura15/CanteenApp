    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "PineappleJuice"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Pineapple Juice item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Pineapple Juice not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/pineapplejuice.png" alt="Pineapple Juice" />
                </div>
            ...
            <div className="description">
                ...
                <p>Pineapple juice is a juice made from pressing the natural liquid out from the pulp of the pineapple. 
                    It is used as a single or mixed juice beverage, and for smoothies, cocktails, culinary flavor, and as a meat tenderizer. 
                    Pineapple juice is a main ingredient in the piña colada and the tepache.</p>       
            </div>
