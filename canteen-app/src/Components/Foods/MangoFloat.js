    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "MangoFloat"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Mango Float item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Mango Float not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/mangofloat.png" alt="Mango Float" />
                </div>
            ...
            <div className="description">
                ...
                <p>Mango Float or crema de mangga is a Filipino icebox cake dessert made with layers of ladyfingers (broas) or graham crackers, whipped cream, condensed milk, 
                    ...
                    It is a modern variant of the traditional Filipino crema de fruta cake.</p>       
            </div>
