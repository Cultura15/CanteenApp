    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const bacon = response.data.find(item => item.name === "Bacon"); // Replace with your actual condition
                
                if (bacon) {
                    console.log('Bacon item:', bacon); // Log the found item
                    setMenuItem(bacon); // Set the fetched item
                } else {
                    console.warn('Bacon not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/bacon.png" alt="Bacon" />
                </div>
            ...
            <div className="description">
                ...
                <p>Bacon is a type of salt-cured pork made from various cuts, typically the belly 
                    or less fatty parts of the back. It is eaten as a side dish, used as a central ingredient,
                    or as a flavouring or accent. Regular bacon consumption is associated with increased mortality and other health concerns.</p>       
            </div>
            ...
            <button className="add-to-cart" onClick={addToCart}>
                ...
                <button className="reserve-item" onClick={() => alert(`Reserved ${quantity} Bacon(s)`)}>
                    Reserve Item
                </button>
