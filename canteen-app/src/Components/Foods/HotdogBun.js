    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const hotdogItem = response.data.find(item => item.name === "HotDog Buns"); // Replace with your actual condition
                
                if (hotdogItem) {
                    console.log('Hotdog item:', hotdogItem); // Log the found item
                    setMenuItem(hotdogItem); // Set the fetched item
                } else {
                    console.warn('Hotdog not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
    ...
    return (
        <div className="sunny-side-up-page">
            ...
            <div className="description">
                ...
                <p>A hot dog is a dish consisting of a grilled, steamed, or boiled sausage 
                    served in the slit of a partially sliced bun. The term hot dog can refer 
                    to the sausage itself. The sausage used is a wiener or a frankfurter. The names 
                    of these sausages commonly refer to their assembled dish.</p>       
            </div>
