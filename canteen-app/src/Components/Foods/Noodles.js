    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "Noodles"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Noodles item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Noodles not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/instantnoodles.png" alt="Instant Noodles" />
                </div>
            ...
            <div className="description">
                ...
                <p>Instant noodles, or instant ramen, is a type of food consisting of noodles sold in a precooked 
                    and dried block with flavoring powder and/or seasoning oil. The dried noodle block was originally created by 
                    flash-frying cooked noodles, which is still the main method used in Asian countries; air-dried noodle blocks are favored in Western countries.</p>       
            </div>
