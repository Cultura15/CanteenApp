    ...
    useEffect(() => {
        const fetchMenuItem = async () => {
            try {
                ...
                const eggItem = response.data.find(item => item.name === "MangoSmoothie"); // Replace with your actual condition
                
                if (eggItem) {
                    console.log('Mango Smoothie item:', eggItem); // Log the found item
                    setMenuItem(eggItem); // Set the fetched item
                } else {
                    console.warn('Mango Smoothie not found in the fetched data.'); // Warn if not found
                }
            } catch (error) {
        ...
        <div className="sunny-side-up-page">
            ...
            <div className="food-detail-container">
                <div className="image-container">
                    <img src="/assets/mangosmoothie.png" alt="Mango Smoothie" />
                </div>
            ...
            <div className="description">
                ...
                <p>This ultra creamy mango smoothie is the best summertime smoothie recipe. 
                    It’s made with fresh mango and a handful of ingredients for the ultimate thirst quencher.</p>       
            </div>
